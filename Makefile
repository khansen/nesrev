...
project-micro-opt:
	@if [ -z "$(PROJECT)" ]; then echo "usage: make project-micro-opt PROJECT=<slug>"; exit 2; fi
	@bash scripts/project_micro_opt_scan.sh $(PROJECT)
