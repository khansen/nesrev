...
four instruction-bearing profiles, but never the old data-only profile.
...
extent checker, and branch-literal leaves. Each validates dependencies and artifact hashes before
