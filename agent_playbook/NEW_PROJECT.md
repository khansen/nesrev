...
| PRG size | $04 plus NES 2.0 byte $09 low nibble | NROM: `1` or `2` units = 16 or 32 KB; MMC1: `1..16` units = 16..256 KB | NROM-128 mirrors at `$C000`; NROM-256 maps at `$8000`; MMC1 emits 16 KB banks with bank-qualified labels, mapping non-final banks at `$8000` and the fixed final bank at `$C000` |
