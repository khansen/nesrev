...
- <a id="tooling-rule-one"></a>**Tooling Rule One: scripts consume structured assembler output, never regex-parse assembly for assembler facts** — [TOOLING.md#rule-one-structured-output](agent_playbook/TOOLING.md#rule-one-structured-output).
...
- <a id="visual-identity-evidence"></a>**Visual identity evidence (static CHR render plus supervised screen capture)** — [PASS_WORKFLOW.md#visual-identity-evidence](agent_playbook/PASS_WORKFLOW.md#visual-identity-evidence); helpers at [TOOLING.md#visual-evidence-tools](agent_playbook/TOOLING.md#visual-evidence-tools).
